...
export const createFormulationSchema = () => ({
  fields: [
    ...MATERIAL_CATALOG.map((material) => ({
      ...
      displayKey: getMaterialOptionLabel(material.id),
    ...
    },
    {
      ...
      displayKey: "Extrusion speed (RPM)",
    ...
    },
    {
      ...
      displayKey: "Printing speed (mm/s)",
