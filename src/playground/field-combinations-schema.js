...
export const FIELD_COMBINATIONS_SCHEMA = {
  fields: [
    ...
    {
      id: "text-below-minimum-length",
      kind: "text",
      displayKey: "Text below minimum length",
      label: "Text below minimum length",
      description: "Valid bounds with a default below minLength.",
      defaultValue: "edge",
      minLength: 8,
      maxLength: 12,
    },
    ...
    },
    {
      ...
      kind: "number",
      displayKey: "Number below minimum",
      label: "Number below minimum",
      description: "Valid bounds with a default below the minimum.",
      defaultValue: 5,
      min: 10,
      step: 1,
    },
    ...
    {
      id: "date-before-minimum",
      kind: "date",
      displayKey: "Date before minimum",
      label: "Date before minimum",
      description: "Valid bounds with a default before the minimum date.",
      defaultValue: "2026-05-15T00:00:00.000Z",
      min: "2026-06-01T00:00:00.000Z",
      max: "2026-06-30T00:00:00.000Z",
    },
  ],
